...
import torch
import dgl
# class Protac_GAT(nn.Module):
#     def __init__(self, in_feats,hidden_feats,heads,activation,dropout):
#         super(Protac_GAT,self).__init__()
#         self.conv = GAT(in_feats=in_feats,hidden_feats=hidden_feats,num_heads=heads,activations=activation,feat_drops=dropout)
