...
import torch
import dgl
class Protac_GATv2(nn.Module):
    def __init__(self, in_feats,hidden_feats,heads,activation,dropout):
        super(Protac_GATv2,self).__init__()
        self.conv = GATv2(in_feats=in_feats,hidden_feats=hidden_feats,num_heads=heads,activations=activation,feat_drops=dropout)
